/*
Привет, студент! Надеюсь, тебе поможет это дерево в реализации твоих контейнеров. Если будут вопрос, можешь смело писать мне в тг.
P.S. подпишитесь на гит и закиньте звезду)
*/
